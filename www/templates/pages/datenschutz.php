<div class="container">
    <section class="section">
        ...
        <div class="content">
            ...
            <p>
                Details entnehmen Sie der Datenschutzerklärung des Anbieters: [URL]
            </p>
            ...
            <p>
                ...
                E-Mail: <a href="mailto:info@hakendran.de">info@hakendran.de</a>
            </p>
            ...
            <p>
                ...
                Endgerät speichert. Cookies helfen uns dabei, unser Angebot nutzerfreundlicher zu machen.
            </p>
            <p>
                Diese Website nutzt folgende Arten von Cookies:
            </p>
            <ul>
                <li><strong>Technisch notwendige Cookies:</strong> Für Login-Funktionen und Dark-Mode-Einstellungen</li>
                <li><strong>Session-Cookies:</strong> Zur Aufrechterhaltung Ihrer Sitzung</li>
            </ul>
            ...
            <h2>5. Newsletter (falls implementiert)</h2>
            <p>
                Informationen zum Newsletter-Versand folgen, wenn dieser Dienst implementiert wird.
            </p>

            <h2>6. Analyse-Tools und Werbung</h2>
            <p>
                Diese Website verwendet derzeit keine Tracking- oder Analyse-Tools von Drittanbietern.
            </p>
            ...
            <p>
                ...
                Diese werden lokal gehostet, es findet keine Verbindung zu Servern von Google statt.
            </p>
